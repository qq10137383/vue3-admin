...
import { MODEL_EVENT, CHANGE_EVENT, FOCUS_EVENT, BLUR_EVENT } from '@/utils/constants'
...
export default defineComponent({
    ...
    emits: [MODEL_EVENT, CHANGE_EVENT, FOCUS_EVENT, BLUR_EVENT],
    setup(props, { emit }) {
        ...
        function handleMdBlur(event: FocusEvent) {
            ...
            if (instance?.parent?.type.name === 'ElFormItem') {
                if (props.validateEvent) {
                    instance.parent.emit('el.form.blur', [currentValue.value])
                }
            }
        }
